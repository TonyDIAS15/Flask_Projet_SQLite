...
# Page d'accueil@app.route('/')
def hello_world():
    return render_template('hello.html')

# Authentification utilisateur/app.route('/authentification', methods=['GET', 'POST'])
...
# Enregistrement de livres@app.route('/enregistrer_livre', methods=['GET', 'POST'])
...
# Suppression de livres@app.route('/supprimer_livre/<int:livre_id>', methods=['POST'])
...
# Recherche de livres disponibles@app.route('/rechercher_livre', methods=['GET'])
...
# Emprunt de livres@app.route('/emprunter_livre/<int:livre_id>', methods=['POST'])
...
# Gestion des utilisateurs@app.route('/ajouter_utilisateur', methods=['POST'])
